...
def adapt_hfc(geometry, basis, active_space, unit='bohr', charge=0, spin=0):
    #PySCF UHF
...
def OH_rad():
    ...
    spin=1
    adapt_hfc(geometry=geometry, basis=basis, active_space=active_space, unit="angstrom", charge=charge, spin=spin)
...
def NO_rad_hfc():
    ...
    adapt_hfc(geometry=geometry, basis=basis, active_space=active_space, charge=charge, spin=spin, unit='angstrom')
