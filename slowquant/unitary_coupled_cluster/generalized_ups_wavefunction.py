...
#     one_electron_integral_transform, two_electron_integral_transform
# )
...
#             self._g_mo = two_electron_integral_transform()  # two_electron_integral_transform(self.c_mo, self._g_ao)
#         return self._g_mo
