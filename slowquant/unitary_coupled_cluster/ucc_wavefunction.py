...
class WaveFunctionUCC:
    def __init__(
        ...
        # The reference determinant is written in the human readable interleaved ordering.
        hf_det_interleaved = "1" * self.num_active_elec + "0" * (
            self.num_active_spin_orbs - self.num_active_elec
        )
        hf_det = int(det_interleaved_to_blocked(hf_det_interleaved), 2)
