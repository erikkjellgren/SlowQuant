...
#
        #self.ups_layout.excitation_indices.append((1,1))
        #self.ups_layout.excitation_operator_type.append("sa_single")
        #self.ups_layout.n_params += 1
#
#
        #self.ups_layout.excitation_indices.append((0,1,2,3))
        #self.ups_layout.excitation_operator_type.append("double")
        #self.ups_layout.n_params += 1
#
        #self.ups_layout.excitation_indices.append((0,0))
        #self.ups_layout.excitation_operator_type.append("sa_single")
        #self.ups_layout.n_params += 1
#
        #self.ups_layout.excitation_indices.append((2,2))
        #self.ups_layout.excitation_operator_type.append("sa_single")
        #self.ups_layout.n_params += 1
#
        #
#
        #self.ups_layout.excitation_indices.append((4,5,6,7))
        #self.ups_layout.excitation_operator_type.append("double")
        #self.ups_layout.n_params += 1
#
#
        
        #self.ups_layout.excitation_indices.append((3,3))
        #self.ups_layout.excitation_operator_type.append("sa_single")
        #self.ups_layout.n_params += 1
#
        #self.ups_layout.excitation_indices.append((1,2))
        #self.ups_layout.excitation_operator_type.append("sa_single")
        #self.ups_layout.n_params += 1
#
#
        ...
        #self.ups_layout.excitation_indices.append((1,2,3,4))
        #self.ups_layout.excitation_operator_type.append("double")
        #self.ups_layout.n_params += 1

        
        #self.ups_layout.excitation_indices.append((2,3,4,5))
        #self.ups_layout.excitation_operator_type.append("double")
        #self.ups_layout.n_params += 1
        ...
        # then oprimise the wave functions
    ...
    def do_adapt2(self):
        ...
        for i in range(20):
            print("Calculation")
            print(self.thetas)
            grad = self.calculate_derivative_with_operator_pool()
            print()
    ...
    def calculate_derivative_of_operator_pool(self):
        ...
        for i in range(len(self.excitation_pool_type)):
            ...
            if self.excitation_pool_type[i] == "single":
                ...
                T = G2(i, j, a, b, True)
            gr = expectation_value(self.ci_coeffs[0],[T, Hamiltonian],  self.ci_coeffs[0],
                                   self.ci_info, self.thetas,self.ups_layout)
            gr -= expectation_value(self.ci_coeffs[0],[ Hamiltonian, T],  self.ci_coeffs[0],
                                   self.ci_info, self.thetas,self.ups_layout)
            grad.append(gr)
    ...
    def run_wf_optimization_1step(
        ...
        self._ci_coeffs = self.csf_coeffs
        res = optimizer.minimize(
            parameters,
            extra_options={"R": self.ups_layout.grad_param_R, "param_names": self.ups_layout.param_names},
        )
