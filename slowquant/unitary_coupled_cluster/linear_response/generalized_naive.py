    ...
    def __init__(
        ...
        # # # print('qq blok regnet med expectation values',self.A)
                ...
                val -= (
                    ...
                    * generalized_expectation_value(
                        self.wf.ci_coeffs,
                        [qI.dagger*qJ.dagger*self.H_1i_1a],
                        self.wf.ci_coeffs,
                        *self.index_info,
                    )
                )
                ...
                val -= (
                    ...
                    * generalized_expectation_value(
                        self.wf.ci_coeffs,
                        [self.H_1i_1a*qJ.dagger*qI.dagger],
                        self.wf.ci_coeffs,
                        *self.index_info,
                    )
                )
        ...
        for j, GJ in enumerate(self.G_ops):
            ...
            for i, GI in enumerate(self.G_ops[j:], j):
                ...
                val = generalized_expectation_value(
                    self.wf.ci_coeffs,
                    [GI.dagger*self.H_1i_1a*GJ.dagger],
                    self.wf.ci_coeffs,
                    *self.index_info,
                )
                # - <0| GId GJd H |0>
                val -= generalized_expectation_value(
                    self.wf.ci_coeffs,
                    [GI.dagger*GJ.dagger*self.H_0i_0a],
                    self.wf.ci_coeffs,
                    *self.index_info,
                )
                # - <0| H GJd GId |0>
                val -= generalized_expectation_value(
                    self.wf.ci_coeffs,
                    [self.H_1i_1a*GJ.dagger*GI.dagger],
                    self.wf.ci_coeffs,
                    *self.index_info,
                )
                # <0| GJd H GId |0>
                val += generalized_expectation_value(
                    self.wf.ci_coeffs,
                    [GJ.dagger*self.H_1i_1a*GI.dagger],
                    self.wf.ci_coeffs,
                    *self.index_info,
                )
                self.B[i + idx_shift, j + idx_shift] = self.B[j + idx_shift, i + idx_shift] = val
