...
def t_RDM2(
    ...
    Args:
        ...
        num_active_orbs: Number of spatial active orbitals.
        rdm1: Active part of 1-RDM.
        t_rdm2: Active part of triplet 2-RDM.
        ...
        for idx2, (m, n) in enumerate(kappa_idx2):
            ...
            for p in range(num_inactive_orbs + num_active_orbs):
                for q in range(num_inactive_orbs + num_active_orbs):
                    ...
                    A2e[idx1, idx2] -= g[n, p, u, q] * t_RDM2(
                        m, p, t, q, num_inactive_orbs, num_active_orbs, rdm1, t_rdm2
                        )
                    A2e[idx1, idx2] += g[n, p, q, t] * t_RDM2(
                        m, p, q, u, num_inactive_orbs, num_active_orbs, rdm1, t_rdm2
                        )
                    A2e[idx1, idx2] += g[u, m, p, q] * RDM2(
                        t, n, p, q, num_inactive_orbs, num_active_orbs, rdm1, rdm2
                        )
                    A2e[idx1, idx2] += g[p, m, u, q] * t_RDM2(
                        p, n, t, q, num_inactive_orbs, num_active_orbs, rdm1, t_rdm2
                        )
                    A2e[idx1, idx2] -= g[p, m, q, t] * t_RDM2(
                        p, n, q, u, num_inactive_orbs, num_active_orbs, rdm1, t_rdm2
                        )
                    A2e[idx1, idx2] -= g[u, p, n, q] * t_RDM2(
                        t, p, m, q, num_inactive_orbs, num_active_orbs, rdm1, t_rdm2
                        )
                    A2e[idx1, idx2] += g[p, t, n, q] * t_RDM2(
                        p, u, m, q, num_inactive_orbs, num_active_orbs, rdm1, t_rdm2
                        )
                    A2e[idx1, idx2] += g[p, q, n, t] * RDM2(
                        p, q, m, u, num_inactive_orbs, num_active_orbs, rdm1, rdm2
                        )
                    A2e[idx1, idx2] += g[u, p, q, m] * t_RDM2(
                        t, p, q, n, num_inactive_orbs, num_active_orbs, rdm1, t_rdm2
                        )
                    A2e[idx1, idx2] -= g[p, t, q, m] * t_RDM2(
                        p, u, q, n, num_inactive_orbs, num_active_orbs, rdm1, t_rdm2
                        )
                    A2e[idx1, idx2] += g[p, q, u, m] * RDM2(
                        p, q, t, n, num_inactive_orbs, num_active_orbs, rdm1, rdm2
                        )
