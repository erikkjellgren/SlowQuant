...
from slowquant.unitary_coupled_cluster.spin_ordering import spin_indices
...
class WaveFunctionCircuit:
    def __init__(
        ...
        if (
            ...
            # These determinants are only used to work out which MO columns to swap, so they
            # stay in the human readable interleaved ordering and never reach a circuit.
