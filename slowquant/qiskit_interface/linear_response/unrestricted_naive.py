...
from slowquant.qiskit_interface.linear_response.unrestricted_lr_baseclass import (
...
class quantumLR(quantumLRBaseClass):
    def run(
        ...
        if self.num_q != 0:
            if do_rdm:
                self.A[: self.num_q, : self.num_q] = get_orbital_response_hessian_block_unrestricted(
                    self.wf.haa_mo,
                    self.wf.hbb_mo,
                    self.wf.gaaaa_mo,
                    self.wf.gbbbb_mo,
                ...
                self.B[: self.num_q, : self.num_q] = get_orbital_response_hessian_block_unrestricted(
                    self.wf.haa_mo,
                    self.wf.hbb_mo,
                    self.wf.gaaaa_mo,
                    self.wf.gbbbb_mo,
                ...
                self.Sigma[: self.num_q, : self.num_q] = get_orbital_response_metric_sigma_unrestricted(
                    self.wf.kappa_no_activeactive_idx,
                    self.wf.num_inactive_orbs,
                    self.wf.num_active_orbs,
                    self.wf.rdm1aa,
